...
class ChassisController:
    def __init__(self, ep_robot, config):
        ...
        self.current_distance = [9999, 9999, 9999, 9999]
    ...
    def handle_all_positions(self, position_info):
        x, y, z = position_info   

    # เพิ่มการเก็บค่าลงในตัวแปรคลาส เพื่อส่งให้ main.py ดึงไปใช้ใน PID
        self.x = x
        self.y = y
        self.z = z

    # โค้ดบันทึก CSV ตามปกติของคุณ...
